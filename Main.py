...
def tempmail_headers() -> dict:
    return {
        ...
        'user-agent': 'celestia/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36'
    }
...
if __name__ == 'Ririkan7':
    password = "Sooya123*!" # You can give random password

    proxy = "user:Ririkan7:port" # I recommend residential proxy, you can also use mobile proxy
    reset_url = "" # reset url for mobile proxy

    mobil_reset = False # mobile reset active/passive

    system("cls")
    system("title Facebook Account Finder ^| @Celeste Spellmam")
